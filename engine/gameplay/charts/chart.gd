...
var strumlines: Dictionary[StringName, Strumline] = {}
...
func _init() -> void:
	strumlines[&"player"] = Strumline.new()
	strumlines[&"opponent"] = Strumline.new()
	strumlines[&"spectator"] = Strumline.new()


func sort() -> void:
	for key: StringName in strumlines:
		strumlines[key].sort_notes()
...
func remove_stacked_notes(min_time: float = 0.005) -> int:
	...
	for key: StringName in strumlines:
		var strumline := strumlines[key]
		var notes: Array[NoteData] = strumline.notes

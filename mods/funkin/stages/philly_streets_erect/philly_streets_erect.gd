...
@export var car_path_1: Path2D
@export var car_follower_1: PathFollow2D
@export var car_1: AnimatedSprite

@export var car_path_2: Path2D
@export var car_follower_2: PathFollow2D
@export var car_2: AnimatedSprite

@export var traffic: AnimatedSprite

@export var mists: Array[Sprite2D] = [
	null,
	null,
	null,
	null,

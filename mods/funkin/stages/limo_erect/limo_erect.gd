...
@export var fast_car: Sprite2D
@export var car_timer: Timer
@export var car_pass: AudioStreamPlayer

@export var dancers: Parallax2D
@export var star_sprite: AnimatedSprite
@export var mists: Array[Node2D] = [
	null,
	null,
	null,
	null,

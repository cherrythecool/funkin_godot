...
@export var track_delay_timer: Timer
@export var background: Sprite2D
@export var songs_parent: Node
@export var song_panel: Panel
...
func change_difficulty(amount: int = 0) -> void:
	...
	song_panel.difficulty_count = difficulties.size()
...
func _load_tracks() -> void:
	...
	music.stream = Tracks.load_tracks(current_song, songs_folder)
	music.play()
